...
class finalDiagnosisCirculatory extends StatefulWidget {
  ...
  const finalDiagnosisCirculatory({Key key, this.name, this.description, this.treatment, this.other, this.image}) : super(key: key);

  @override
  _finalDiagnosisCirculatoryState createState() => _finalDiagnosisCirculatoryState();
}
